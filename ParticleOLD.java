...
public class ParticleOLD {
     ...
     */
    public ParticleOLD(double rx, double ry, double vx, double vy, double radius, double mass, Color color) {
        this.vx = vx;
        this.vy = vy;
        this.rx = rx;
        this.ry = ry;
     ...
     */
    public double timeToHit(ParticleOLD that) {
     ...
     * @param  that the other particle
     */
    public void bounceOff(ParticleOLD that) {
        double dx  = that.rx - this.rx;
        double dy  = that.ry - this.ry;
        double dvx = that.vx - this.vx;
        double dvy = that.vy - this.vy;
